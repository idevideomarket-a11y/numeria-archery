    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-100 to-sky-50 flex flex-col">
      <div className="flex justify-between items-center p-4">
        ...
        <div className="flex gap-2 md:gap-4">
          <div className="bg-white/80 px-3 py-2 md:px-4 rounded-full shadow-md flex items-center gap-1 md:gap-2">
            <Trophy size={18} className="text-academy-gold" />
            <span className="font-bold text-dark-text text-sm md:text-base">{totalXP} XP</span>
          </div>
          <div className="bg-white/80 px-3 py-2 md:px-4 rounded-full shadow-md flex items-center gap-1 md:gap-2">
            <span className="text-lg md:text-xl">🪙</span>
            <span className="font-bold text-dark-text text-sm md:text-base">{coins}</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 md:px-6 py-6 md:py-8">
        ...
        >
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-dark-text mb-2">
            <span className="text-academy-gold">Numeria</span> Archery
          </h1>
          <p className="text-gray-600 text-base md:text-lg">Math Meets Archery!</p>
        </motion.div>
        ...
        >
          <div className="w-24 h-24 md:w-32 md:h-32 bg-gradient-to-br from-academy-gold to-orange-300 rounded-full flex items-center justify-center text-5xl md:text-6xl shadow-lg mb-4 mx-auto animate-bounce-gentle">
            🏹
          </div>
          <p className="text-lg md:text-xl font-bold text-dark-text">Welcome back, {playerName}!</p>
          <p className="text-gray-600 text-sm md:text-base">{completedCount} levels completed • {totalStars} stars earned</p>
        </motion.div>
